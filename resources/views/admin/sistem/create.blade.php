...
@section('page-title', 'Tambah Sistem')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-0">Tambah Sistem Baru</h4>
        <p class="text-muted mb-0">Tambahkan sistem pembelajaran baru</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.sistem.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('keunggulan') is-invalid @enderror"
                            id="keunggulan" name="keunggulan" rows="4" required>{{ old('keunggulan') }}</textarea>
                        @error('keunggulan')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
