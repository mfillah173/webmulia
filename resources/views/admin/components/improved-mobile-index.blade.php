{{--
    Template Universal untuk Mobile-Friendly Admin Index (Improved Version)
    Menghilangkan redundansi filter status
    Usage: @include('admin.components.improved-mobile-index', [
        'items' => $items,
        'itemName' => 'berita',
