...
@section('page-title', 'Galeri Program')
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-images me-2"></i>Galeri Program
                    </h5>
                    <a href="{{ route('admin.galeri-program.create') }}" class="btn btn-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card h-100">
                            <div class="card-img-top-container">
                                ...
                                <div class="card-overlay">
                                    <div class="card-overlay-content">
                                        <a href="{{ route('admin.galeri-program.show', $item) }}"
                                            class="btn btn-sm btn-outline-light me-1">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.galeri-program.edit', $item) }}"
                                            class="btn btn-sm btn-outline-light me-1">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.galeri-program.destroy', $item) }}"
                                            method="POST"
                                            class="d-inline"
                            ...
                            <div class="card-body">
                                <h6 class="card-title">{{ $item->program->nama ?? 'Program Tidak Ditemukan' }}</h6>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('admin.galeri-program.toggle-status', $item) }}"
                                        method="POST"
                                        class="d-inline">
                                        @csrf
                                        <button type="submit"
