...
@section('title', 'Tambah Gambar Galeri Program')
@section('page-title', 'Tambah Gambar Galeri Program')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fas fa-plus-circle me-2"></i>Tambah Gambar Galeri Program
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.galeri-program.store') }}" method="POST" enctype="multipart/form-data" id="galeriForm">
                    @csrf
