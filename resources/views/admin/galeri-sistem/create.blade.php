...
@section('title', 'Tambah Gambar Galeri Sistem')
@section('page-title', 'Tambah Gambar Galeri Sistem')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fas fa-plus-circle me-2"></i>Tambah Gambar Galeri Sistem
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.galeri-sistem.store') }}" method="POST" enctype="multipart/form-data" id="galeriForm">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('sistem_id') is-invalid @enderror" id="sistem_id" name="sistem_id" required>
                            ...
                            <option value="{{ $sistem->id }}" {{ old('sistem_id') == $sistem->id ? 'selected' : '' }}>
                                {{ $sistem->nama }}
                            </option>
                            @endforeach
                        </select>
