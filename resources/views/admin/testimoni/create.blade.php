...
<div class="page-header mb-4">
    <div class="page-header-content">
        <div class="page-header-text">
            ...
            <p class="page-subtitle">Buat testimoni baru untuk website</p>
        </div>
            ...
            <form action="{{ route('admin.testimoni.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-help">Foto narasumber yang akan ditampilkan di website. Format: JPG, JPEG, PNG, GIF. Maksimal 2MB</div>
                        @error('gambar')
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                        </div>
