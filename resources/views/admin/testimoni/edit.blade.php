...
<div class="page-header mb-4">
    <div class="page-header-content">
        <div class="page-header-text">
            ...
            <p class="page-subtitle">Perbarui informasi testimoni: {{ $testimoni->nama_narasumber }}</p>
        </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                <h3 class="form-card-title">
                    <i class="fas fa-quote-left me-2"></i>Informasi Testimoni
                </h3>
                <p class="form-card-subtitle">Lengkapi informasi testimoni</p>
            </div>
            ...
            <form action="{{ route('admin.testimoni.update', $testimoni) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-card-body">
                    ...
                    <div class="form-group">
                        <label for="nama_narasumber" class="form-label required">
                            <i class="fas fa-user me-1"></i>Nama Narasumber
                        </label>
                        <input type="text" 
                            class="form-control @error('nama_narasumber') is-invalid @enderror"
                            id="nama_narasumber" 
                            name="nama_narasumber"
                            value="{{ old('nama_narasumber', $testimoni->nama_narasumber) }}" 
                            required
                            autocomplete="off">
                        <div class="form-help">Nama lengkap narasumber testimoni</div>
                    ...
                    <!-- Jabatan -->
                    <div class="form-group">
                        <label for="jabatan" class="form-label required">
                        ...
                        <input type="text" 
                            ...
                            required
                            autocomplete="off">
                        <div class="form-help">Jabatan atau posisi narasumber</div>
                        @error('jabatan')
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        <label for="deskripsi" class="form-label required">
                            <i class="fas fa-comment me-1"></i>Testimoni
                        </label>
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                            id="deskripsi" 
                            name="deskripsi" 
                            rows="5" 
                            required>{{ old('deskripsi', $testimoni->deskripsi) }}</textarea>
                        <div class="form-help">Isi testimoni dari narasumber</div>
                        @error('deskripsi')
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        <label for="gambar" class="form-label">
                            <i class="fas fa-image me-1"></i>Foto Narasumber
                        </label>
                        @if($testimoni->gambar)
                        <div class="mb-3">
                            <img src="{{ asset('storage/images/testimoni/' . $testimoni->gambar) }}"
                                ...
                                id="currentImage"
                                style="max-width: 100%; height: auto; border-radius: 8px; border: 1px solid var(--gray-200);">
                            <div class="form-help">Foto saat ini</div>
                        </div>
                        @endif
                        <input type="file" 
                        ...
                        <div class="form-help">Foto narasumber yang akan ditampilkan di website. Format: JPG, JPEG, PNG, GIF. Maksimal 2MB. Kosongkan jika tidak ingin mengubah foto.</div>
                        @error('gambar')
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                        </div>
...
<style>
    ...
    /* Page title - only for content area page-header, not topbar */
