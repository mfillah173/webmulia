...
@section('title', 'Galeri Fasilitas')
@section('page-title', 'Galeri Fasilitas')
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.galeri-fasilitas.create') }}" class="btn btn-primary">
                        ...
                        <div class="card h-100">
                            <div class="card-img-top-container">
                                <img src="{{ $item->image_url }}"
                                    alt="Galeri Fasilitas"
                                    class="card-img-top"
                                    style="height: 200px; object-fit: cover;">
                                <div class="card-overlay">
                                    <div class="card-overlay-content">
                                        <a href="{{ route('admin.galeri-fasilitas.show', $item) }}"
                                            class="btn btn-sm btn-outline-light me-1">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.galeri-fasilitas.edit', $item) }}"
                                            class="btn btn-sm btn-outline-light me-1">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.galeri-fasilitas.destroy', $item) }}"
                                            method="POST"
                                            class="d-inline"
                            ...
                            <div class="card-body">
                                <h6 class="card-title">{{ $item->fasilitas->nama ?? 'Fasilitas Tidak Ditemukan' }}</h6>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('admin.galeri-fasilitas.toggle-status', $item) }}"
                                        method="POST"
                                        class="d-inline">
                                        @csrf
                                        <button type="submit"
