...
<div class="page-header mb-4">
    <div class="page-header-content">
        <div class="page-header-text">
            ...
            <p class="page-subtitle">Kelola fasilitas Mulia Special Academy</p>
        </div>
...
<div class="facilities-grid" id="facilitiesGrid">
    ...
    <div class="facility-card" data-status="{{ $fasilitasItem->status }}" data-name="{{ strtolower($fasilitasItem->nama) }}">
        <div class="facility-card-header">
            <div class="facility-image">
                @if($fasilitasItem->gambar)
                <img src="{{ $fasilitasItem->image_url }}"
            ...
            <div class="facility-status">
                <form action="{{ route('admin.fasilitas.toggle-status', $fasilitasItem) }}" method="POST" class="d-inline">
                    @csrf
                    <button type="submit" class="status-toggle {{ $fasilitasItem->status === 'active' ? 'status-active' : 'status-inactive' }}">
                        <i class="fas {{ $fasilitasItem->status === 'active' ? 'fa-eye' : 'fa-eye-slash' }}"></i>
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="facility-card-body">
            <div class="facility-info">
                <h3 class="facility-title">{{ $fasilitasItem->nama }}</h3>
                <p class="facility-description">{{ Str::limit($fasilitasItem->deskripsi, 100) }}</p>
            </div>

            <div class="facility-meta">
                <div class="meta-item">
                    <i class="fas fa-sort-numeric-up me-1"></i>
                    <span>Urutan: {{ $fasilitasItem->urutan }}</span>
                </div>
                <div class="meta-item">
                    <i class="fas fa-calendar me-1"></i>
                    <span>{{ $fasilitasItem->created_at->format('d M Y') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="facility-card-footer">
            <div class="facility-actions">
                <a href="{{ route('admin.fasilitas.show', $fasilitasItem) }}"
                    class="btn btn-outline-info btn-sm"
                    title="Lihat Detail">
                    <i class="fas fa-eye"></i>
                </a>
                <a href="{{ route('admin.fasilitas.edit', $fasilitasItem) }}"
                    class="btn btn-outline-warning btn-sm"
                    title="Edit Fasilitas">
                    <i class="fas fa-edit"></i>
                </a>
                <form action="{{ route('admin.fasilitas.destroy', $fasilitasItem) }}"
                    method="POST"
                    class="d-inline"
...
<div class="empty-state">
    <div class="empty-state-content">
        ...
        <p class="empty-state-subtitle">Mulai dengan menambahkan fasilitas pertama</p>
        <a href="{{ route('admin.fasilitas.create') }}" class="btn btn-primary">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterFacilities() {
            ...
            facilityCards.forEach(card => {
                ...
                const matchesStatus = !statusValue || facilityStatus === statusValue;
