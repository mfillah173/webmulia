...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('storage/images/logo msa baru.png') }}?v={{ time() }}">
    <link rel="apple-touch-icon" href="{{ asset('storage/images/logo msa baru.png') }}?v={{ time() }}">
...
<body>
    ...
    <script>
        ...
        // Navbar mobile menu - Bootstrap handles toggle automatically
        // No need for custom toggle as Bootstrap collapse already handles it via data-bs-toggle
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Navbar alignment untuk mobile - hamburger di kiri, logo di kanan */
            .navbar>.container {
                display: flex;
                align-items: center;
                gap: 0.5rem;
